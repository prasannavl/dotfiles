...
NIX_DEPS="nixpkgs#bash nixpkgs#coreutils nixpkgs#gawk nixpkgs#gnome-keyring nixpkgs#niri nixpkgs#procps nixpkgs#swayidle nixpkgs#swaylock nixpkgs#systemd"
