...
NIX_DEPS="nixpkgs#bash nixpkgs#coreutils nixpkgs#gawk nixpkgs#gnome-keyring nixpkgs#procps nixpkgs#sway nixpkgs#swayidle nixpkgs#swaylock nixpkgs#systemd"
